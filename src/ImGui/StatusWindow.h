...
public:
    ...
    void SetSceneSaveCallback(const std::function<void()>& callback) { m_sceneSaveCallback = callback; } // Scene saving
...
private:
    ...
    std::function<void()> m_sceneSaveCallback; // Save callback
